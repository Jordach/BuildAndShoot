...
pause >nul
mkdir models
copy "C:\Ace of Spades\wav\*.wav" "%CD%\sounds"
pause
goto :error
:error
cls
ECHO If you did not see all the files copy, check the sounds folder. If it still isn't there, you may have entered the wrong information. Try again.
pause
goto :directorylist